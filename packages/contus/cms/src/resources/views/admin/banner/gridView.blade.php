            ...
            <table class="table" data-ng-init="bannerCtrl.setQuery('{{auth()->user()->id}}')">
                ...
                <tbody>
                    ...
                    <tr data-ng-if="showRecords" data-ng-repeat="record in records track by $index" data-ng-show="showRecords" class="list-repeat" data-intialize-sidebar="">
                        ...
                        <video width="320" height="240" controls ng-src="@{{record.video_image}}" src="@{{record.video_image}}">
                        </td>
...
<nav class="st-menu st-effect-17" id="menu-17">
        ...
        <form name="bannerForm" method="POST" data-base-validator data-ng-submit="bannerCtrl.save($event,bannerCtrl.banner.id)" enctype="multipart/form-data">
            ...
            <div class="video_form add_form">
                ...
                <div class="form-group" data-ng-class="{'has-error': errors.title.has}">
                    ...
                    <input type="text" name="title" data-ng-model="bannerCtrl.banner.title" class="form-control" placeholder="{{trans('cms::staticcontent.title_placeholder_banner')}}" value="{{old('title')}}" />
                ...
                <div class="form-group" data-ng-class="{'has-error': errors.category.has}">
                    ...
                    <p class="help-block" data-ng-show="errors.category.has">@{{ errors.category.message }}</p>
                </div>
                <div class="form-group" data-ng-class="{'has-error': errors.imageUrl.has}">
                    <label class="control-label">
                       Image url
                        <span class="asterisk">*</span>
                    </label>
                    <input type="text" name="imageUrl" data-ng-model="bannerCtrl.banner.imageUrl" class="form-control" placeholder="Image url" value="{{old('imageUrl')}}" />
                    <p class="help-block" data-ng-show="errors.imageUrl.has">@{{ errors.imageUrl.message }}</p>
                </div>
                    ...
                    <div flow-object="existingFlowObject" flow-init flow-file-added="!!{png:1,gif:1,jpg:1,jpeg:1}[$file.getExtension()]" flow-files-submitted="$flow.upload()">
                        <div class="">
                            ...
                            <div>
                                ...
                                <input type="hidden"  ng-if="!bannerCtrl.banner.banner_image" value="{{URL::to('/')}}/@{{bannerCtrl.banner.url}}">
                                    <img ng-if="!bannerCtrl.banner.banner_image" src="{{URL::to('/')}}/@{{bannerCtrl.banner.url}}" />
                                    <img style="width:180px;height:180px;" ng-if="bannerCtrl.banner.banner_image" flow-img="$flow.files[0]" />
                                </div>
                                <div>
 ...
 <img src ="{{ url('contus/base/images/admin/loader.gif') }}" alt="ImageLoader" height="100" width="100">
                        ...
                        <div ng-if="bannerCtrl.banner.type =='image'">
                            <img alt="" class="cs-testimonial-img" ng-src="@{{bannerCtrl.banner.banner_image}}" src="@{{bannerCtrl.banner.banner_image}}">
                        </div>
                    </div>
                 ...
                 <input type="hidden" name="video_image" id="postImage" data-ng-model="bannerCtrl.banner.video_image" value="{{old('video_image')}}" />
