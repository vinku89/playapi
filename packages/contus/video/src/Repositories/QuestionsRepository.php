...
class QuestionsRepository extends BaseRepository
{
    ...
    public function setNotification($questions)
    {
        ...
        } elseif ($this->request->has('question')) {
        ...
        if ($questions->user_type == 'customer') {
            ...
            $notificationcomments = $this->authUser->name . ' has commented on the video ' . $videos->title;
        } elseif ($questions->user_type == 'admin') {
    ...
    {
        return ['heading' => [['name' => trans('video::videos.name'), 'value' => 'name', 'sort' => false], ['name' => trans('video::videos.student'), 'value' => '', 'sort' => false], ['name' => 'Questions', 'value' => '', 'sort' => false], ['name' => trans('video::playlist.status'), 'value' => 'is_active', 'sort' => false], ['name' => trans('video::collection.added_on'), 'value' => '', 'sort' => false]]];
    }
