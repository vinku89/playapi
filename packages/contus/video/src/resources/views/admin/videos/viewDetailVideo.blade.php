    ...
    <div class="contentpanel clearfix video-detail" data-ng-if="!vVideoDetailsCtrl.notFoundFlag">
        ...
        <div class="video-detail-left-panel">
            <div class="video-detail-profile-images">
                <img src="{{url('contus/base/images/no-preview.png')}}" data-ng-src="@{{ video.thumbnail_image }}" alt="" width="" height="" />
            ...
            <div class="video-detail-views" ng-if="video.pdf">
                <!-- <span><i class="time-icon"></i> 2h 24min </span> -->
                <span>
                    <a target="_blank" href="https://s3-ap-southeast-1.amazonaws.com/contus-vplay/@{{video.pdf}}">PDF</a>
                </span>
            </div>
            <div class="video-detail-views" ng-if="video.word">
                <!-- <span><i class="time-icon"></i> 2h 24min </span> -->
                <span>
                    <a target="_blank" href="https://s3-ap-southeast-1.amazonaws.com/contus-vplay/@{{video.word}}">WORD</a>
                </span>
            </div>
            <div class="video-detail-views" data-ng-hide="video.is_live">
                <!-- <span><i class="time-icon"></i> 2h 24min </span> -->
                <span>
                    <i class="view-icon"></i>
                    @{{video.recent}} Views
        ...
        <div class="video-detail-right-panel">
            <div class="clearfix play-video-container">
                <div class="play-video">
                    ...
                    <div class="video-detail-title">
                        <div class="play-video-detail" data-ng-hide="video.is_live">
                ...
                <div class="play-video-column">
                        ...
                        <ul>
                            <li>
                                <div class="mp4-format">
                                    ...
                                    <div class="mp4-format-title" data-ng-hide="video.is_live">
                                        <h5>HLS</h5>
                                        <p>m3u8 Format</p>
                                    </div>
                    ...
                    <div class="video-writer">
                        ...
                        <div class="video-writer-detail" data-ng-hide="video.is_live">
                            <label>Genre</label>
                ...
                <div class="comments-answer-tab">
                    <div class="tabbable-panel">
                        ...
                        <div class="media replied-question">
                            ...
                            <div class="media-body">
                                <textarea ng-model="parentquestion" class="form-control textare-question" rows="3" placeholder="Question" maxlength="1000"></textarea>
                                <p class="text-right">
                                    <button type="button" ng-click="parentquestion=''" class="btn btn-sm btn-cancel">Clear</button>
                                    <button type="button" ng-click="postparentquestion(parentquestion)" class="btn btn-sm btn-action">Question</button>
                                </p>
                            </div>
                        </div>
                        <div class="text-center">
                            <a class="view-more-questions" ng-show="question.prev_page_url !== null" href="javascript:;" ng-click="loadprevquestion()">Show Previous</a>
                        </div>
                        <div class="media replied-question" ng-repeat="que in question.data">
                            <div class="media-left">
                                <a href="javascript:;" title="" class="replied-user img-circle">
                                    <img alt="" class=" media-object" ng-src="@{{que[que.user_type].profile_picture}}" src="{{url('contus/base/images/user.png')}}" data-holder-rendered="true" style="width: 64px; height: 64px;">
                                </a>
                            </div>
                            <div class="media-body">
                                <h4 class="media-heading">
                                ...
                                <p>@{{que.questions}}</p>
                                <span class="label label-success" ng-if="que.is_active == 1" style="cursor: pointer;" data-ng-click="updateQAStatus(que,'0')" title="{{trans('video::videos.deactivate_qa')}}" data-boot-tooltip="true">{{trans('video::playlist.message.active')}}</span>
                                <span class="label label-danger" ng-if="que.is_active != 1" style="cursor: pointer;" data-ng-click="updateQAStatus(que,'1')" title="{{trans('video::videos.activate_qa')}}" data-boot-tooltip="true">{{trans('video::playlist.message.inactive')}}</span>
                                <p>
                                    <a href="javascript:;" class="reply-link" ng-click="isReplyFormOpen = !isReplyFormOpen">
                                        <span ng-hide="isReplyFormOpen">Reply</span>
                                        <span ng-hide="!isReplyFormOpen">close</span>
                                    ...
                                    <a href="javascript:;" ng-show="que.reply_answer[0].id" class="reply-link show-question" ng-click="isReplycontentOpen = isReplyFormOpen = !isReplycontentOpen">
                                        <span ng-hide="isReplycontentOpen">Show </span>
                                        <span ng-hide="!isReplycontentOpen">Hide </span> reply questions
                                    </a>
                                </p>
                                <div ng-show="isReplyFormOpen" class="media replied-question">
                                    <div class="media-body">
                                        <textarea ng-model="childquestion[que.id]" class="form-control textare-question" rows="3" placeholder="Question" maxlength="1000"></textarea>
                                        <p class="text-right">
                                            <button type="button" ng-click="childquestion=''" class="btn btn-sm btn-cancel">Clear</button>
                                            <button type="button" ng-click="postchildquestion(que.id,childquestion[que.id])" class="btn btn-sm btn-action">Submit</button>
                                        </p>
                                    </div>
                                </div>
                                <div ng-hide="!isReplycontentOpen" ng-repeat="subque in que.reply_answer" class="comment-reply">
                                    <div class="media-left">
                                        <a href="javascript:;" title="" class="replied-user img-circle">
                                            <img alt="" class=" media-object"  ng-src="@{{subque[subque.user_type].profile_picture}}"  src="{{url('contus/base/images/user.png')}}" data-holder-rendered="true" style="width: 64px; height: 64px;">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <h4 class="media-heading">
                        ...
                        <div class="text-center">
                            <a class="view-more-questions" ng-show="question.next_page_url !== null" href="javascript:;" ng-click="loadmorequestion()">View More</a>
                        </div>
                        </uib-tab> </uib-tabset>
                    </div>
                </div>
