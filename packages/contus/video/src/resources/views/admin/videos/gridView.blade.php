    ...
    <div class="tab-content">
        <div class="tab-pane active" id="latest_video">
            <div class="tab_search clearfix">
                ...
                <a ng-hide="true" href="{{url('admin/youtube-live')}}" ng-if="!livedetails.updated_at" class="btn btn-info " ng-class={}>{{__('video::videos.synclivevideos')}}</a>
            </div>
                    ...
                    <tr class="search_text">
                        ...
                        <td data-ng-show="tabSelected =='live_videos'">
                            <select class="form-control mb15" data-ng-change="search()" data-ng-model="searchRecords.type" data-boot-tooltip="true" title="{{__('base::general.type')}}">
                                <option value="all" >{{__('base::general.all')}}</option>
                                <option value='wowza' selected>{{__('base::general.wowza')}}</option>
                            ...
                            <div class="product_img">
                                <a href="{{url('admin/videos/view-details-video')}}/@{{record.id}}">
                                        <span class="img_title">
                                            <img src="{{url('contus/base/images/no-preview.png')}}" data-ng-src="@{{ record.thumbnail_image }}" alt="" />
                                        </span>
                                ...
                                <div ng-if="record.username !== ''">
                                    <button data-ng-if="tabSelected =='live_videos'" class="btn btn-sm ng-scope" data-toggle="modal" data-target="#deleteModals@{{ record.id }}"><i class="fa fa-info-circle"></i>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="playlsitForm" method="POST" data-base-validator="" data-ng-submit="vgridCtrl.Playlistsave($event)" enctype="multipart/form-data">
                    ...
                    <div class="collection_model">
                        <div class="collection_listing">
                            <div class="rdio rdio-primary collection_listing_input" data-ng-repeat="(key, value) in vgridCtrl.allPlaylists">
                                <input type="radio" name="radio" data-ng-value="@{{key}}" data-ng-model="vgridCtrl.playlsit.id" ng-click="vgridCtrl.createPlaylist(key)"  id="radioPrimaryplay_@{{key}}">
                    ...
                    <div class="modal-footer">
                        <a href="#" class="btn btn-default  mr10" data-dismiss="modal">Cancel</a>
                        <button type="submit" class="btn btn btn-primary" ng-disabled="vgridCtrl.btnStatus">Submit</button>
                    </div>
                </form>
            </div>
        </div>
