<div class="menu_container clearfix">
    <div class="page_menu pull-left">
        <ul class="nav">
            ...
            <li>
                <a href="{{url('admin/livevideos')}}" data-ng-click="selectTab('live_videos')" data-ng-class="{'active': requestParams.grid == 'livevideos'}" >{{trans('video::videos.livevideos')}}</a>
            </li>
            ...
            <li ng-hide=true>
                <a href="{{url('admin/qa')}}" data-ng-class="{'active': requestParams.grid == 'qa'}" >{{trans('video::videos.qa')}}</a>
            </li>
        </ul>
    </div>
</div>