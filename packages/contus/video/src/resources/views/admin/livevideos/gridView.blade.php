                        ...
                        <tr class="search_text">
                            ...
                            <td>
                                <select class="form-control mb15" data-ng-change="search()" data-ng-model="searchRecords.is_active" data-boot-tooltip="true" title="{{trans('base::general.select_status')}}">
                                    ...
                                    <option value='1' selected>{{trans('video::collection.banner.active')}}</option>
                                    <option value='0'>{{trans('video::collection.banner.inactive')}}</option>
                                </select>
                            </td>
                            <td data-ng-show="tabSelected =='live_videos'">
                                <select class="form-control mb15" id="selectType" data-ng-change="search()" data-ng-model="searchRecords.type" data-boot-tooltip="true" title="{{trans('base::general.type')}}">
                                    <option value="all">{{trans('base::general.all')}}</option>
                                    <option value='wowza' selected>{{trans('base::general.wowza')}}</option>
                                    <option value='private'>{{trans('base::general.youtube_private')}}</option>
                                    <option value='public'>{{trans('base::general.youtube_public')}}</option>
                                    <option value='unlisted'>{{trans('base::general.youtube_unlisted')}}</option>
                                </select>
                            </td>
                            <td></td>
                            <td data-ng-hide="tabSelected !='live_videos'"></td>
