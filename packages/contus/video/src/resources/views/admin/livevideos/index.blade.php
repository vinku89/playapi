    ...
    <div id="video_forms1" class="video-container" data-base-validator>
                <form name="videoEditForm" method="POST" data-base-validator data-ng-submit="vgridCtrl.saveVideoEdit($event)" enctype="multipart/form-data">
                    <div>
					    ...
					    <div class="clearfix">
                        <div class="form-group wid-50 p-right" data-ng-class="{'has-error': errors.category_ids.has}" data-ng-hide="editVideo.is_live">
                            <label class="control-label">
                        ...
                        <div class="form-group wid-50" data-ng-class="{'has-error': errors.exam_ids.has}"  data-ng-hide="editVideo.is_live">
...
<script src="{{$getVideoAssetsUrl('js/videos/livevideoGrid.js')}}"></script>
