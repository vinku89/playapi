...
/**
 * Customer Favourite Album Controller
 *
 * @name Customer FavouriteAlbumController
 * @vendor Contus
 * @package Audio
 * @version 1.0
...
use Contus\Audio\Repositories\FavouriteAlbumRepository;
use Contus\Customer\Models\Customer;
use Illuminate\Http\Request;

class FavouriteAlbumController extends ApiController {
    ...
    public function __construct() {
        parent::__construct ();
        $this->repository = new FavouriteAlbumRepository();
    ...
    public function index() {
        $data = $this->repository->getAllFavouriteAlbums ();
