...
var UserController = ['$scope','requestFactory','$window','$sce','$timeout',function ( scope, requestFactory, $window, $sce, $timeout ) {
    ...
    this.addUser = function ( $event ) {
        ...
        scope.examSelection = [];
        this.user.age = '';
        $('#age').datepicker({format:"dd-mm-yyyy",startDate:"-100 Y",viewMode: 'years',endDate:new Date(),autoclose: true});
        this.user.password_confirmation = '';
        this.user.is_active = String( 1 );
    ...
    */
    this.editUser = function ( records ) {
        ...
        $('#age').datepicker({format:"dd-mm-yyyy",startDate:"-100 Y",viewMode: 'years',autoclose: true}).datepicker('setDate', records.dob);
        scope.examSelection = [];
    ...
    */
    this.save = function ( $event, id ) {
        if ( baseValidator.validateAngularForm( $event.target, scope ) ) {
            ...
            //    console.log(requestFactory.getUrl( 'customers/' + id ));
